...
if(request.getParameter("submit") != null){
	...
	//else if(!user.isEmailOrPhoneExist(userName)) {
		
	//}
	else if(!userName.matches("[1-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]")){
		message = "Mobile number given is incorrect!";
			...
			<div class="col-xs-12 col-sm-4">
				...
				<div class="rs_form_box">
					...
					<div class="input-group">
						<label>Mobile*</label>
						<input type="text" value="<%=request.getParameter("cname")%>" name="phone" class="form-controller">
					</div>
					<div class="input-group">
